		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealcoustomeraccountstatement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealcoustomeraccountstatement-display": {
								"semanticObject": "comibsibsappidealcoustomeraccountstatement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealcoustomeraccountstatement",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealcoustomeraccountstatement")
								}
							}
						}
					}
