		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealdistributorstockdata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealdistributorstockdata-display": {
								"semanticObject": "comibsibsappidealdistributorstockdata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealdistributorstockdata",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealdistributorstockdata")
								}
							}
						}
					}
