		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealidealpaymentcreation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealidealpaymentcreation-display": {
								"semanticObject": "comibsibsappidealidealpaymentcreation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealidealpaymentcreation",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealidealpaymentcreation")
								}
							}
						}
					}
