		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealpaymentapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealpaymentapproval-display": {
								"semanticObject": "comibsibsappidealpaymentapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealpaymentapproval",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealpaymentapproval")
								}
							}
						}
					}
