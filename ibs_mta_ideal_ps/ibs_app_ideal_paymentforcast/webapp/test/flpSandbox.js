		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsibsappidealpaymentforcast-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealpaymentforcast-display": {
								"semanticObject": "comibsibsappidealpaymentforcast",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealpaymentforcast",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealpaymentforcast")
								}
							}
						}
					}
