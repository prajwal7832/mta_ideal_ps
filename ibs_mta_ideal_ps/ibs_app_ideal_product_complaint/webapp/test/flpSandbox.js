		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealproductcomplaint-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealproductcomplaint-display": {
								"semanticObject": "comibsibsappidealproductcomplaint",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealproductcomplaint",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealproductcomplaint")
								}
							}
						}
					}
