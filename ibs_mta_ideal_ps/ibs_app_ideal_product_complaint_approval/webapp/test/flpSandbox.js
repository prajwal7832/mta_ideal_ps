		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealproductcomplaintapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealproductcomplaintapproval-display": {
								"semanticObject": "comibsibsappidealproductcomplaintapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealproductcomplaintapproval",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealproductcomplaintapproval")
								}
							}
						}
					}
