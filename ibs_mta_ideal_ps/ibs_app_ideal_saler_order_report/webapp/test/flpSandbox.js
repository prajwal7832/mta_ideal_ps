		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealsalerorderreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealsalerorderreport-display": {
								"semanticObject": "comibsibsappidealsalerorderreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealsalerorderreport",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealsalerorderreport")
								}
							}
						}
					}
