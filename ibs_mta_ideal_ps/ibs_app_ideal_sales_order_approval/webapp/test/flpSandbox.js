		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealsalesorderapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealsalesorderapproval-display": {
								"semanticObject": "comibsibsappidealsalesorderapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealsalesorderapproval",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealsalesorderapproval")
								}
							}
						}
					}
