		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealorderdispatch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealorderdispatch-display": {
								"semanticObject": "comibsibsappidealorderdispatch",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealorderdispatch",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealorderdispatch")
								}
							}
						}
					}
