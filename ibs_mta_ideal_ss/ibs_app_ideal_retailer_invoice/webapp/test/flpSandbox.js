		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealretailerinvoice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealretailerinvoice-display": {
								"semanticObject": "comibsibsappidealretailerinvoice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealretailerinvoice",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealretailerinvoice")
								}
							}
						}
					}
