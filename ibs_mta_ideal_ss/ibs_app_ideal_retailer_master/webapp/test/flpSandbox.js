		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealretailermaster-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealretailermaster-display": {
								"semanticObject": "comibsibsappidealretailermaster",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealretailermaster",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealretailermaster")
								}
							}
						}
					}
