		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealretailerpayment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealretailerpayment-display": {
								"semanticObject": "comibsibsappidealretailerpayment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealretailerpayment",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealretailerpayment")
								}
							}
						}
					}
