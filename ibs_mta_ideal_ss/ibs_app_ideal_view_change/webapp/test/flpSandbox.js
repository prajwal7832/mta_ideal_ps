		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibsibsappidealviewchange-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsibsappidealviewchange-display": {
								"semanticObject": "comibsibsappidealviewchange",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.ibsappidealviewchange",
									"url": sap.ui.require.toUrl("com/ibs/ibsappidealviewchange")
								}
							}
						}
					}
